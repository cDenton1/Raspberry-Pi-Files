# need to tweak to include an LCD screen and adjust the potentiometer to be used for user input
# also need to add FCFS logic to create a proper simulation - 2026/04/05 currently in progress
